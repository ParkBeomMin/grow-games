...
const CACHE = "soccer-v13";  // 🐛 명단의 내 줄이 안 오르던 것  // 🐛 출전 수 두 번 세던 것 · 우승 화면 다음 상대  // 🥇 개막 전 개인 순위  // 🧯 이어하던 세이브 개인 순위 메우기   // 🥇 리그 전 선발 개인 순위   // 🛡️ 대회 수비 부문   // 📈 동료 성장·노쇠   // 🎉 fever.js 추가   // 🏛️ 명예의 전당 달 탭·헌액 카드   // 🌏 worldcup.js   // 👥 squad.js·🔥 camp.js + 항상 재검증
