...
> 🚨 **"멈췄습니다"라고 말했으면 정말 멈춰 있어야 합니다.**
> 검증자에게 그렇게 알린 뒤 구현자를 재개시키면, 검증자는 **자기가 잰 값을 믿습니다** —
> 그리고 그 값은 이미 다른 소스의 것입니다.
>
> 실제로 두 번 겪었습니다. 재개시켜야 하면 **먼저 검증자에게 알리세요.**
> 검증이 끝날 때까지 기다리는 쪽이 대개 더 빠릅니다 — 다시 재는 비용이 더 커요.
