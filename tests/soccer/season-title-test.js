...
/* ⚠️ 골 수는 ⚽ 득점 눈금(GOAL_SCALE 0.33)이 들어가면서 다시 잡았어요.
 * 같은 문턱(7.6/6.0/3.5)에 닿는 시즌 성적이 통째로 내려왔습니다 —
 * 종합 85 선수의 한 시즌이 83골에서 38골이 됐으니 당연해요.
 * 문턱 자체는 안 건드렸어요. 여기 값은 그 문턱에 닿는 새 성적입니다. */
const K1_SAME = [
  [95, 20, 20, "리그를 지배한 시즌!"],
  [40, 15, 15, "제 몫을 해낸 시즌"],
  [18, 10, 10, "아쉬움이 남는 시즌"],
