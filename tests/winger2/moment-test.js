 ...
 *    지금 걸려 있는 값은 「보통」 **+0.0012** (계약 ≤ 0.005 · 116번 §3-2).
 *
 ...
 * ══════════════════════════════════════════════════════════════ */
{
  const WANT = {
     ...
     *      서툰 +0.013 · **보통 +0.0012** (계약 ≤ 0.005 ✅) · 능숙 +0.050 (🟡 balancer에게 넘김)
    ...
    "ONE_WIN": 22, "ONE_CLOSE": 0.45, "CELL_FLOOR": 0.30,
  ...
  const AXIS = {
    ...
    CELL_FLOOR: "🏔️ s의 천장 — **`ONE_WIN`이 여기 매달린 종속값**이라 표 한 줄을 통째로 가져오세요"
      + "\n           📮 balancer가 **0.30 → 0.36**을 재고 있습니다(116번 §7-1: 16.67 × 0.36 = 6.0으로"
      + " 5칸 시절 바닥과 같아져요). 그 값이 들어오면 **여기와 `ONE_WIN`을 한 벌로** 갱신하세요",
