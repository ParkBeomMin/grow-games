...
const MARKETS = [
  ...
  {
    id: "grad", name: "전공 대학원", emoji: "🔬", tier: "연구 코스",
    debut: 0.63, growth: 1.08, spot: 1.1,
    desc: "논문·연구로 깊이를 파요. AI·데이터 쪽 전문성이 강하게 붙어요",
  },
  {
    id: "club", name: "개발 동아리·해커톤", emoji: "🚀", tier: "실전 코스",
    debut: 0.6, growth: 1.14, spot: 1.08,
    desc: "사이드 프로젝트로 부딪히며 성장. 실전 감각과 협업이 빠르게 늘어요",
  },
];
...
const MOMENTS = {
  ...
  collab: {
    good: ["날카로운 코드리뷰로 팀을 살렸어요! 🤝", "CI/CD 파이프라인을 매끄럽게 구축 ✨", "장애 대응을 침착하게 리드했어요 🔥"],
    bad: ["리뷰 코멘트가 살짝 늦었어요 😬", "배포 롤백에 진땀을 뺐어요 💦"],
  },
};
...
function openHelp() {
  if (window.Help) window.Help.open("💻 더 커밋 도움말", HELP_SECTIONS);
}
