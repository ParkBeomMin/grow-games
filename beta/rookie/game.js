    ...
    run: (box, tier, cb) => {
      ...
      window.PostStage.count(box, {
        ...
        msg: bat ? null : {
          ...
          readyLines: [
            "공이 날아오다 도중에 <b>휘어요</b>. 점선 네모(존) 안으로 꽂히는 <b>승부구</b>인지, 밖으로 빠지는 <b>유인구</b>인지 보고 정해요.",
            "던지려다 빠지거나 승부구를 그냥 보내면 <b>몰려요</b>. 3번 몰리면 한복판을 얻어맞고, 유인 4번이면 타자가 무너져요.",
            "꽂아도 <b>유인이 몰림보다 많을 때</b>만 완벽이에요 — 완벽에 닿으려면 적어도 한 번은 흘려보내야 해요.",
          ],
          readyShort: "존을 벗어나는 공은 흘려보내요 · 타자를 흔든 뒤 꽂은 승부구만 완벽해요",
          readySwing: "누르면 승부구를 꽂아요. 존 안이면 끝내고, 밖이면 빠져요",
