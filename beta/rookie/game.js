 ...
 *              그리고 **공이 꺾인 뒤에 낸 방망이만** 제대로 맞아요 (타이밍)
  ...
  count: {
    ...
    run: (box, tier, cb) => {
      ...
      window.PostStage.count(box, {
        label: bat
          ? "🧊 가을야구의 한 타석! 공이 꺾인 뒤에 판단해요 — 벗어나면 참고, 유리해진 뒤에 노려쳐요"
          : "🧊 상대 4번과의 승부! 코스가 갈린 뒤에 결정해요 — 유인구는 흘려보내고, 승부구로 끝내요",
        button: bat ? "스윙! 🏏" : "승부! 🔥",
        ...
        msg: bat ? null : {
          ...
          hitGood: "🔥 승부구를 던졌어요!",
          whiff: "🌀 던지려다 빠졌어요…",
          /* ⏱️ 코스가 갈리기 전에 손을 쓴 자리. 투수도 뜻은 같아요 — 아직 정해지지
           * 않은 공에 미리 걸었으니 제대로 꽂힐 리가 없어요. */
          foul: "🫧 급하게 꽂았어요 — 빗맞은 파울",
          rush: "🌀 갈리기 전에 던져서 빠졌어요…",
          looking: "😐 승부구를 그냥 보냈어요",
          taken: "👀 유인구에 타자가 흔들려요",
          out: "❌ 한복판을 얻어맞았어요…",
          free: "🚶 타자가 완전히 무너졌어요",
          timeup: "⏱️ 승부 종료",
          stall: "⏱️ 파울로 버티는 사이 승부가 끝났어요",
          cueWait: "🙈 아직 코스가 안 갈렸어요",
          cueRead: "👁️ 갈렸어요! 지금 결정해요",
          tip: "눈금(┊)을 <b>넘은 뒤에</b> 결정해요 · 벗어나는 공은 <b>유인구</b>, 타자를 흔든 뒤 꽂은 승부구가 완벽해요",
          /* 🧭 준비 화면도 투수 말로 갈아끼워요. 같은 규칙인데 부호가 반대라,
           * 여기만 타자 말로 남으면 "볼을 골라내라"는 설명을 투수가 읽게 돼요.
           * ⚠️ readySwing·readyTake에는 태그를 넣지 마세요 — 버튼 설명 칸에 그대로 들어가요. */
          readyLines: [
            "공이 날아오다 도중에 <b>휘어요</b>. 휘기 전에는 코스가 안 갈려요 — 아래 막대의 눈금(┊)이 그 자리예요.",
            "<b>눈금을 넘은 뒤에</b> 꽂은 공만 제대로 들어가요. 그 전에 손을 쓰면 존 안이어도 빗맞은 파울이에요.",
            "던지려다 빠지거나 승부구를 그냥 보내면 <b>몰려요</b>. 3번 몰리면 한복판을 얻어맞고, 유인 4번이면 타자가 무너져요.",
            "꽂아도 <b>유인이 몰림보다 많을 때</b>만 완벽이에요 — 완벽에 닿으려면 적어도 한 번은 흘려보내야 해요.",
          ],
          readyShort: "눈금(┊)을 넘은 뒤에 결정해요 · 벗어나는 공은 흘려보내고, 타자를 흔든 뒤 꽂은 승부구만 완벽해요",
          readySwing: "누르면 승부구를 꽂아요. 눈금을 넘은 뒤 존 안이면 끝내고, 넘기 전이면 빗맞아요",
          readyTake: "안 누르면 흘려보내요. 존 밖이면 유인구가 돼서 타자가 흔들려요",
        },
      }, cb);
    },
  },
