...
const RENAMED = {
  // 실존 구단 → 가상
  "LG 트윈스": "한백 트윈스", "두산 베어스": "태평 베어스", "키움 히어로즈": "미르 히어로즈",
  "SSG 랜더스": "해든 랜더스", "KT 위즈": "다온 위즈",
  "한화 이글스": "청우 이글스", "KIA 타이거즈": "나래 타이거즈",
  "삼성 라이온즈": "한별 라이온즈", "롯데 자이언츠": "우주 자이언츠", "NC 다이노스": "대륙 다이노스",
  // 잠깐 나갔던 지역명 버전 → 가상
  "서울 코메츠": "한백 트윈스", "남산 팰컨스": "태평 베어스", "강남 스파크스": "미르 히어로즈",
  "인천 앵커스": "해든 랜더스", "수원 나이츠": "다온 위즈",
  "금강 크레인스": "청우 이글스", "무등 블레이즈": "나래 타이거즈",
  "팔공 썬더스": "한별 라이온즈", "부산 타이푼스": "우주 자이언츠", "창원 웨이브스": "대륙 다이노스",
  // 실존 고교명 → 가상
...
const HELP_SECTIONS = [
  ...
  { emoji: "⭐", title: "재능과 각성", body:
    ...
    "능력치가 상한(100)에 닿으면 🔮각성으로 재능을 올릴 수 있어요. 재능이 최대가 되면\n" +
    "🌠초월로 상한 자체를 올려요 — 성공할수록 어려워지지만 명예의 전당 점수가 크게 붙어요." },
  { emoji: "🏆", title: "대회와 드래프트", body:
    "고교 3년 동안 대회가 6번 열려요(6월 황금사자기 · 8월 청룡기).\n" +
    "성적이 스카우트 주목도를 올리고, 3학년이 끝나면 그 주목도로 드래프트 지명이 갈려요.\n" +
