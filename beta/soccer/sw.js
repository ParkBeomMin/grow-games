...
const CACHE = "soccer-v19";  // ⚡ 스피드 · 🫀 체력이 소모를 줄여요 · 🛡️ 명전 수비  // 📍 세부 자리  // 🏆 내 몫도 팀 스코어에서  // 🏆 팀 성적과 개인 기록 통합  // 📊 능력치 레이더 · 🦶 주발과 약발  // 🛌 벤치 컨디션 회복  // 🐛 명단의 내 줄이 안 오르던 것  // 🐛 출전 수 두 번 세던 것 · 우승 화면 다음 상대  // 🥇 개막 전 개인 순위  // 🧯 이어하던 세이브 개인 순위 메우기   // 🥇 리그 전 선발 개인 순위   // 🛡️ 대회 수비 부문   // 📈 동료 성장·노쇠   // 🎉 fever.js 추가   // 🏛️ 명예의 전당 달 탭·헌액 카드   // 🌏 worldcup.js   // 👥 squad.js·🔥 camp.js + 항상 재검증
